package com.commonTest.demo6_kt;
...
//		System.out.println(ascii);
    ...
    public static String getPy1(String chs) {
        return getPy1(chs, true);
    }

    public static String getPy1(String chs, boolean haveSepareator) {
        ...
        for (int i = 0; i < chs.length(); i++) {
            ...
            py.append(value + (haveSepareator ? " " : ""));
        }
        return py.toString();
    }
    ...
    public static void main(String[] args) {
        System.out.println(getPy1("曹飞", false).toLowerCase());//caofei
    }
